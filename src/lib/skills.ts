...
export type SkillSource = 'wiki' | 'gt-cloud' | 'prototemplate';

/** The published groups; the id is the sidebar section id on /skills. */
export type SkillCategory = 'engineering' | 'productivity' | 'general-translation' | 'graphics';
...
export const SKILLS: readonly Skill[] = [
  ...
  },
  {
    ...
    category: 'graphics',
    source: 'prototemplate',
  },
  {
    id: 'docs-source-capture',
