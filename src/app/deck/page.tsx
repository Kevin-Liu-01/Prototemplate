...
export const metadata: Metadata = {
  ...
  description:
    'The General Translation brand in 63 slides: thesis, values, writing style, mark, color, type, line rules, diagrams, dither, motion, the shipped site and every public surface, docs, blog, content rules, prototemplate, glyphfield, fixed points, and current status.',
