...
export default function Bento() {
  ...
  return (
    <section className='tc-sec' id='features' ref={root}>
      ...
      <div className='tc-delivery-band'>
        {/* The fork's identity swap: the delivery band is washed by the same
            aurora material as the hero, in its ink register — one material,
            photographed at night. The band never remaps with theme. */}
        <AuroraWash className='tc-delivery-field' preset='ink' speed={0.45} />
