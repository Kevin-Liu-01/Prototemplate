...
/**
 * The typing review workspace (toolchain's founder-batch primitive), embedded
 * in this fork's review section rather than standing as its own section: the
 * fork's ReviewFlow keeps its head, diff and review card, and this mount is
 * its live surface. Source beside translation, a GSAP loop in which one row
 * at a time writes itself and a stamp settles from `translated` to its rest.
 * Every other row sits complete, so the workspace reads as a finished still
 * at any frame; under reduced motion the resting DOM *is* that still.
 */
export default function ReviewWorkspace() {
  ...
  return (
    <div className='tcr-mat' data-reveal ref={root}>
