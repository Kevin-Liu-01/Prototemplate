 ...
 * Three glazed panels in the lattice: the published rate ledger as a ruled
 * table, then Starter at $0, then Enterprise at Custom. The seven rates
 * and the two footnotes are the only figures on the page's price side
 * (charter A10); whole dollars print without cents. Nothing here moves.
 */
    ...
    <section className='bl-sec bl-price-sec' id='pricing'>
      ...
      <div className='bl-in'>
        ...
        <div className='bl-price-grid'>
          <article className='bl-panel bl-ledger'>
            <h3>Usage rates</h3>
          ...
          <article className='bl-panel bl-plan'>
            <h3>Starter</h3>
            <p className='bl-plan-price'>
              $0<small>per month</small>
            </p>
            <p className='bl-plan-body'>
              Unlimited users, projects and languages. Editor, GitHub integration and Locadex included. Minimum
              top-up $10.
            </p>
