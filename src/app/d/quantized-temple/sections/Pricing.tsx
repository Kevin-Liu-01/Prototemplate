...
import TierCrest from './deco/TierCrest';
import { useQuietReveal } from './reveal';

/**
 * Pricing, the ledger way. A price is a number in a column, so the module
 * leads with the full published rate table as a real ruled table: workflow in
 * the label gutter, rate right-aligned, GT-library variant in a third column.
 * These are the only rates that may appear anywhere. The two plans follow;
 * nothing on this module moves on its own.
 */
  ...
  return (
    <section className='tc-sec' id='pricing' ref={root}>
      <div className='tc-head'>
        <TierCrest tiers={6} className='tc-head-icon' />
