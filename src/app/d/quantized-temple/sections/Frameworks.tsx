...
export default function Frameworks() {
  ...
  useGSAP(
    () => {
      ...
      if (!list || !bar) return;
      /* Under reduced motion the underline and the panel jump to their
         resting pose; the tab change itself is the only thing that moves. */
  ...
  return (
    <section className='tc-sec' id='frameworks' ref={root}>
      <div className='tc-head'>
        <TierCrest tiers={2} className='tc-head-icon' />
