...
/** Slim, ruled, and quiet: the column's top edge more than a navigation bar.
    The ground is dark in both themes, so the light-stroke mark is the one
    that shows; the CSS hides the other. */
    ...
    <header className='tc-nav' data-tc-nav>
      <div className='tc-nav-in'>
        ...
        <nav className='tc-nav-links'>
          ...
          <a href='https://generaltranslation.com/blog'>Blog</a>
          <a href='https://generaltranslation.com/enterprise'>Enterprise</a>
        </nav>
