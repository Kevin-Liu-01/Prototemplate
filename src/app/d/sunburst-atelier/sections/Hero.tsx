...
import Roundel from './deco/Roundel';
import GtWord from './GtWord';
    ...
    <section className='tc-sec tch-hero-sec' id='top' ref={root}>
      ...
      <div className='tch-split'>
        <div className='tc-hero tch-card tch-copy'>
          {/* The hero crown (C1.4): five stacked arcs with their windows, and
              the monogram in a chrome roundel seated on the hub. */}
          <div className='sba-crown-wrap' data-hero-in>
            <Crown />
            <Roundel />
          </div>
          ...
          <p className='tc-hero-sub' data-hero-in>
            <GtWord /> builds full-stack infrastructure for localizing apps, docs, and websites.
          </p>
