  ...
  return (
    <section className='tc-band tcb' id='toolchain' ref={root}>
      <div className='tcb-in'>
        {/* The band lede under the crown (C1.5): the deco layer's fullest
            statement, centered, before the grid returns to GT's cells. */}
        <div className='tcb-head sba-band-head' data-cell>
          <Crown className='sba-band-crown' />
