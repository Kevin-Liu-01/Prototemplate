 ...
 * it without a visible join. Hover pauses the loop; reduced motion gets the full static
...
export default function Frameworks() {
  ...
  useGSAP(
    () => {
      ...
      if (!list || !bar) return;
      /* Under reduced motion the underline still has to sit under the active
         tab (it is functional), so it is placed with a set, never a tween, and
         the panel swap has no entrance. */
    ...
    <section className='tc-sec' id='frameworks' ref={root}>
      ...
      >
        ...
        <div className='tc-fw-side'>
          ...
          <a className='tc-fw-link' href={`https://generaltranslation.com${framework.docs}`}>
