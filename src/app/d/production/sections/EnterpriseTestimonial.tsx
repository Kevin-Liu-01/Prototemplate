...
/**
 * The shipped TestimonialSection (services-landing/TestimonialSection.tsx).
 *
 * The Cursor word on a quiet ink plate, seated between the hero and the
 * contact ask: bounded by the page's end-to-end border lines with corner
 * crosses closing its foot, a whisper of the Bayer material on its right
 * flank. Same words as the shared CursorTestimonial (which the YC page
 * keeps); only the staging is the enterprise rail's.
 */
