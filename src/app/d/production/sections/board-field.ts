/* Vendored verbatim from the shipped landing app
   (apps/landing/src/components/blog/board-field.ts). Zero imports, zero
   app coupling — the blog masthead's split-flap canvas engine, unchanged. */
