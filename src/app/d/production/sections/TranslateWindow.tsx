...
import '@/app/d/_v0/translate-window.css';

gsap.registerPlugin(useGSAP);

/* ------------------------------------------------------------------
   THE TRANSLATE WINDOW — the PRODUCTION-PINNED copy.

   This final is a reproduction, not a direction, so its hero mounts
   its own copy of the window rather than the shared one at
   src/app/d/_v0/TranslateWindow.tsx: the shared component is the
   directions' furniture and drifts with them, and this file has to
   stay bolted to the shipped page
   (apps/landing/src/components/landing/home/sections/TranslateWindow.tsx).
   It is that file line for line, minus gt-next: the belt runs
   en · es · ja · de · ko · fr · … and the transcript's translate line
   names the product — "Translating with Platform Context".

   One window, ONE bar row: no title —
      ...
      <div className='tct-stage'>
        ...
        >
          <div className='tct-body'>
            ...
            <div className='tct-line tct-meta' data-ts>
              {'  Translating with Platform Context'}
            </div>
            <div className='tct-gap' />
