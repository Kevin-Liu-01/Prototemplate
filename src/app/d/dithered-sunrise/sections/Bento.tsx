...
import BayerBand from './deco/BayerBand';
  ...
  return (
    <section className='tc-sec' id='platform' ref={root}>
      <div className='tc-head'>
        <DawnCrest className='tc-head-icon' id='ds-crest-platform' />
