...
import DawnCrest from './deco/DawnCrest';
...
export default function Frameworks() {
  ...
  useGSAP(
    () => {
      ...
      if (!list || !bar) return;
      /* Under reduced motion the underline and the panel snap to the active
         tab; the placement itself still runs, it is layout, not motion. */
  ...
  return (
    <section className='tc-sec' id='frameworks' ref={root}>
      <div className='tc-head'>
        <DawnCrest className='tc-head-icon' id='ds-crest-frameworks' />
