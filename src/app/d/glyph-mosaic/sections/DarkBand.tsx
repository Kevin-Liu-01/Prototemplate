...
import { panelBloom, useDitherField } from '../fields';
...
export default function DarkBand() {
  ...
  return (
    <section className='tc-band tcb' id='toolchain' ref={root}>
      ...
      {/* The floor (C1.5): the paper-on-ink chevron frieze, below every line of type. */}
      <GlyphMosaic variant='frieze' className='gm-band-frieze' cell={12} seed={7} />
    </section>
  );
}
