...
import MosaicDivider from './deco/MosaicDivider';
  ...
  return (
    <section className='tc-sec' id='platform' ref={root}>
      <div className='tc-head'>
        <MosaicCrest className='tc-head-icon' seed={23} />
