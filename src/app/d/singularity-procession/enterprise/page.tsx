...
/**
 * Singularity · Procession — the gate, then the march. The shared
 * enterprise composition under the hero, in this final's ceremonial
 * dress: the record set at monument scale, the statements passing one
 * at a time — pure ceremony, spent on conversion.
 */
