...
export const metadata = {
  title: 'Blog — Procession — GT Redesign',
  icons: { icon: '/brand/no-bg-gt-logo-light.png' },
};

/**
 * Blog — the shared company composition in the singularity grammar,
 * wearing the Procession accent sheet. The sections are built once under
 * ../../singularity/company-sections; this wrapper only sets the root.
 */
export default function SingularityProcessionBlogPage() {
  return (
    <SmoothScroll>
