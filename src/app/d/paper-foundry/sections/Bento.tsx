...
export default function Bento() {
  ...
  useQuietReveal(root);
  /* Foundry identity: framed cells enter as machined parts — the reading-order
     cascade with a one-shot gloss sweep apiece (`data-plate`) — while flat text
     keeps the quiet reveal (`data-reveal`). */
