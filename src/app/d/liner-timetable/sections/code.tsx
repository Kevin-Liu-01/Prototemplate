...
export type CodeBlockProps = {
  file: string;
  code: string;
  /** A board label before the file name, in the bar's own mono voice. */
  label?: string;
...
export default function CodeBlock({ file, code, label, numbers = true }: CodeBlockProps) {
  ...
  return (
    <div className='tc-code' data-numbers={numbers}>
      <div className='tc-code-bar'>
        <span>
          {label ? <span className='tc-code-label'>{label} · </span> : null}
          {file}
        </span>
