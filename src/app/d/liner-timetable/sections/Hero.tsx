...
import CrownRule from './deco/CrownRule';
    ...
    <section className='tc-sec tch-hero-sec' id='top' ref={root}>
      ...
      <div className='tch-split'>
        <div className='tc-hero tch-card tch-copy'>
          {/* The crown (charter C1.4): the monogram lockup. The GT mark seated
              between two gold doubled rules, each closed by a diamond
              terminal; the one hero moment the deco layer owns above the h1. */}
          <div className='lt-crown' data-hero-in>
            <CrownRule />
            <Image
          ...
          <p className='tc-hero-sub' data-hero-in>
            <span className='lt-wordmark'>
              <Image className='tc-logo-light' src='/brand/no-bg-gt-logo-light.png' alt='' width={14} height={14} />
              <Image className='tc-logo-dark' src='/brand/no-bg-gt-logo-dark.png' alt='' width={14} height={14} />
              General Translation
            </span>{' '}
        ...
        {/* The plate: the hero's media panel, and the field fills ALL of it, source dock on the left edge, greetings materialising across the
