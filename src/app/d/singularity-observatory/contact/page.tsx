...
export const metadata = {
  title: 'Contact — Observatory — GT Redesign',
  icons: { icon: '/brand/no-bg-gt-logo-light.png' },
};

/**
 * Contact — the shared company composition in the singularity grammar,
 * wearing the Observatory accent sheet. The bay shares its DNA with the
 ...
 */
export default function SingularityObservatoryContactPage() {
  return (
    <SmoothScroll>
