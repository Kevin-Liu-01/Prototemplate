...
export const metadata = {
  title: 'Blog — Observatory — GT Redesign',
  icons: { icon: '/brand/no-bg-gt-logo-light.png' },
};

/**
 * Blog — the shared company composition in the singularity grammar,
 * wearing the Observatory accent sheet. The sections are built once under
 * ../../singularity/company-sections; this wrapper only sets the root.
 */
export default function SingularityObservatoryBlogPage() {
  return (
    <SmoothScroll>
