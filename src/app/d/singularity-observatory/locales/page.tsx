...
export const metadata = {
  title: 'Supported Locales — Observatory — GT Redesign',
  icons: { icon: '/brand/no-bg-gt-logo-light.png' },
};

/**
 * Supported Locales — the shared company composition in the singularity
 * grammar, wearing the Observatory accent sheet. All 120 rows come from
 * the exact data path the old landing page read at runtime; the sections
 * are built once under ../../singularity/company-sections.
 */
export default function SingularityObservatoryLocalesPage() {
  return (
    <SmoothScroll>
      <div className='singularity-root sgb-root' id='top'>
        <TopNav />
