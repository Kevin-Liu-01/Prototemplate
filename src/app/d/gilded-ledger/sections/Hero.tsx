...
export default function Hero() {
  ...
  return (
    <section className='tc-sec tch-hero-sec' id='top' ref={root}>
      {/* The stack, split: the ivory copy leaf beside the transmission plate,
          two leaves on the gold mat with one 1px gold seam between them; the
          trust strip repeats the leaf grammar below. */}
      <div className='tch-split'>
        <div className='tc-hero tch-card tch-copy'>
          {/* The crown: the monogram cartouche between doubled gold rules,
              the title page's device above the title (deco home C1.4). */}
          <Crown />
          ...
          <p className='tc-hero-sub' data-hero-in>
            <GtWordmark /> builds full-stack infrastructure for localizing apps, docs, and
            websites.
          </p>
      ...
      {/* The trust strip: six real wordmarks, cap-height aligned, ruled into
          six cells. The claim is the lead; the restraint is the diagram. */}
