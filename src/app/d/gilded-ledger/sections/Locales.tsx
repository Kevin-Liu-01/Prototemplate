...
/**
 * M13, Locales: the colophon of scripts. "100+ languages" converted from a
 * marketing number into a technical claim by expanding one language into its
 * real regional variants. Four rows, verbatim from `packages/supported-locales`;
 * the two-second tell is `zh-Hans` and `zh-Hant` sitting adjacent as different
 * things, ringed in the page's one accent.
 *
 * Beside the table, the halftone globe: a printed atlas plate in its gold
 * frame, turning slowly.
 */
