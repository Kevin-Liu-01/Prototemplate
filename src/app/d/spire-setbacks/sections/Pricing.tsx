  ...
  return (
    <section className='tc-sec' id='pricing' ref={root}>
      <div className='tc-head'>
        {/* The section pictogram seated on the string course, as every other
            head on the column carries one (C1.1). */}
        <Receipt className='tc-head-icon' strokeWidth={1} aria-hidden />
