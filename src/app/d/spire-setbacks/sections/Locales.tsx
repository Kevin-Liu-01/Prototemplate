  ...
  return (
    <section className='tc-sec' id='locales' ref={root}>
      ...
      <div className='tc-row is-lead'>
        {/* The directory: the variants table framed on the brass mat, the
            way a lobby directory sits in its brass surround. The table itself
            is GT's; only the frame is the thesis. */}
        <div className='tc-cell is-tall is-framed' data-reveal>
          <div className='tc-card ss-directory'>
