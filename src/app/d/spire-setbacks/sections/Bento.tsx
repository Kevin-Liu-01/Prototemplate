    ...
    <section className='tc-sec' id='platform' ref={root}>
      ...
      <div className='tc-row is-split'>
        <div className='tc-cell is-tall' data-reveal>
          <h3>Code</h3>
          <p>
            Developer-first libraries for React, Next.js, and more, running in production apps.
          </p>
          <ul className='tc-list'>
            <li>
              <code className='tc-chip'>&lt;T&gt;</code> wraps any JSX, nested elements included
            </li>
            <li>
      ...
      <div className='tc-row is-tilt'>
        <div className='tc-cell is-framed' data-reveal>
          <div className='tc-card'>
            <h3>Built for every user</h3>
            {/* Four numbers, none redundant. */}
