...
import SpireCrown from './deco/SpireCrown';
    ...
    <section className='tc-sec tch-hero-sec' id='top' ref={root}>
      ...
      <div className='tch-split'>
        <div className='tc-hero tch-card tch-copy'>
          {/* The crown (C1.4): a stepped setback in ink linework over a brass
              sunburst, the mark seated in its base tier. The one hero moment
              the deco layer is allowed above the claim. */}
          <div className='ss-crown' data-hero-in>
            <SpireCrown />
            <Image
