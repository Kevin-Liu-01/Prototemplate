 ...
 * singularity grammar wearing the Orbit accent sheet. The sections are built
 * once under ../../singularity/company-sections; this wrapper only sets the
 * root.
 */
export default function SingularityOrbitLegalPage() {
  return (
    <SmoothScroll>
