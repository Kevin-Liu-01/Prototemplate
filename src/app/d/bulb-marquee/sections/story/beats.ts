...
export const BEATS: readonly Beat[] = [
  {
    ...
    body: 'Every text node is picked up where it stands: nav label, heading, body copy, button, legal line. The markup around it travels as its context.',
  ...
  },
  {
    ...
    body: 'A commit triggers the workflow. Locadex reads the file that changed, the source that produced the strings.',
  ...
  },
  {
    ...
    body: 'One PR, six locales, a diff you can read. Review it like any other change. Merge it, and the site is live in every language.',
