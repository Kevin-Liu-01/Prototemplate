...
/**
 * BULB-MARQUEE: the fork's field compositions, inherited from dither-field.
 *
...
export function useDitherField(
  ...
  useMountEffect(() => {
    ...
    // Mount-once by contract: the factory identity is stable (module-level
    // functions) and the options are read through optsRef.
  });
