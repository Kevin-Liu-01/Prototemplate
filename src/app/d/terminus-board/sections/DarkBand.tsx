...
/**
 * The page's one full-bleed dark band — toolchain's calm v3 cut, headed by
 * this direction's flap phrase: every cell is heading + one line + one quiet
 * artifact. The centerpiece is the seven-plane stack, a real instrument —
 * each plane and each caption row is a two-way hover/focus/tap target (GSAP
 * raises and brightens the plane, pulls its leader to full ink, and lights
 * its caption), and the left connector is a doubled rail the planes tap off
 * with radiused corners. Scroll reveals are one-shot and legible at any
 * stop; reduced motion gets the finished still with instant hover states.
 */
    ...
    <section className='tc-band tcb' id='toolchain' ref={root}>
      <div className='tcb-in'>
        <div className='tcb-head' data-cell>
          <h2>
            Everything you need, <FlapPhrase text='in one toolchain.' />
          </h2>
