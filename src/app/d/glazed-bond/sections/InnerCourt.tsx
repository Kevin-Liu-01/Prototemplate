 ...
 * full width of the elevation with four tablets set into its bond. The
 * libraries tablet carries the shipped gt-next sample; the CLI tablet the
 * `gt translate` run; the dashboard tablet the review workspace, source
 * beside translation; the Locadex tablet the agent's findings and its
 * pull request. The floor dissolves in a turquoise dither. The court's
 * glaze never remaps: it is dark in both themes.
 */
