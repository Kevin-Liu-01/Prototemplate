...
export default function Bento() {
  ...
  return (
    <section className='tc-sec' id='platform' ref={root}>
      ...
      {/* ---- shell 6: mounted object left, flat copy right ---- */}
        ...
        <div className='tc-cell is-framed' data-reveal>
          <div className='tc-card'>
            <div className='tc-quad'>
              ...
              <div>
                <h3>Glossaries</h3>
                <p>Pin a term once and it stays pinned, across every later run.</p>
                <div className='tc-surface'>
                  <GlossarySurface title='The term Vault pinned across German, Spanish and Japanese' />
                </div>
              </div>
            </div>
          </div>
