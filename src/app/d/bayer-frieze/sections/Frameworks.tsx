...
import { StepKey } from './deco/Ornaments';
...
export default function Frameworks() {
  ...
  useGSAP(
    () => {
      ...
      /* Under reduced motion the underline jumps and the panel swaps in
         place; the markup pose is the still. */
  ...
  return (
    <section className='tc-sec' id='frameworks' ref={root}>
      <div className='tc-head'>
        <StepKey className='tc-head-icon' />
      ...
      >
        ...
        <div className='tc-fw-side'>
          ...
          <a className='tc-fw-link' href={framework.docs}>
