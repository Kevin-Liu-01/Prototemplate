...
import { Sunrise } from './deco/Ornaments';
    ...
    <section className='tc-sec tch-hero-sec' id='top' ref={root}>
      ...
      <div className='tch-split'>
        <div className='tc-hero tch-card tch-copy'>
          {/* The crown (C1 hero crown): the Bayer sunrise around the mark, the
              jade horizon rule under it. The mark stays the drawn PNG, one ink,
              seated in the sunrise's clear hub. */}
          <div className='bf-crown' data-hero-in>
            <Sunrise className='bf-crown-sun' />
            <Image
          ...
          {/* The wordmark rides inline in the sub: the monogram in the copy's
              own ink, with the words kept as a visually hidden text node so
              selection and screen readers still read "General Translation". */}
          <p className='tc-hero-sub' data-hero-in>
            <span className='bf-gtword'>
              <span className='bf-gtword-copy'>General Translation</span>
