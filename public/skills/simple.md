...
| --- | --- | --- |
| `dedalus-simple` | [`references/skills/dedalus-simple/SKILL.md`](references/skills/dedalus-simple/SKILL.md) | Frame any technical answer as a reproducible five-part diagnosis with labeled sections. Use when the user asks for a root-cause explanation, a fix proposal, a debugging write-up, or says "explain why", "what''s the problem", "propose a fix", or invokes `/simple`. Forces the answer into labeled sections: Problem, Evidence, Proposal, Mechanism, Test. |
