...
Use `~/Documents/GitHub/kevin-wiki/wiki/tools/math-curve-loaders.md` only when
the loader is a branded mathematical/data/AI motion artifact. Keep ordinary
product loading on skeletons plus `BrailleSpinner`.
...
<!-- auto-promoted from skills/engineering/dedalus-loading-screens by sync-dedalus on 2026-06-13; review & generalize any Dedalus-specific references. -->
...
| --- | --- | --- |
| `dedalus-loading-screens` | [`references/skills/dedalus-loading-screens/SKILL.md`](references/skills/dedalus-loading-screens/SKILL.md) | Implement loading states using braille Unicode spinners and skeleton placeholders. Use when adding loading indicators, replacing spinners, or building new loading screens. Covers component API, sizing, spinner selection, and anti-patterns. |
