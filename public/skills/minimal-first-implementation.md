...
<!-- auto-promoted from skills/engineering/dedalus-minimal-first-implementation by sync-dedalus on 2026-06-13; review & generalize any Dedalus-specific references. -->
...
| --- | --- | --- |
| `dedalus-minimal-first-implementation` | [`references/skills/dedalus-minimal-first-implementation/SKILL.md`](references/skills/dedalus-minimal-first-implementation/SKILL.md) | Build the smallest correct version first. Name every case, implement only what has a real consumer, return typed errors for the rest. Use when designing new systems, extracting shared packages, or deciding how much to build before shipping. |
