...
| --- | --- | --- |
| `claude-skill-auditor` | [`references/skills/claude-skill-auditor/SKILL.md`](references/skills/claude-skill-auditor/SKILL.md) | Comprehensive security auditor for OpenClaw skills. Checks for typosquatting, dangerous permissions, prompt injection, |
