...
<!-- auto-promoted from skills/engineering/dedalus-postmortem by sync-dedalus on 2026-06-13; review & generalize any Dedalus-specific references. -->
...
| --- | --- | --- |
| `dedalus-postmortem` | [`references/skills/dedalus-postmortem/SKILL.md`](references/skills/dedalus-postmortem/SKILL.md) | Run a blameless postmortem for a production incident. Investigate with data, write a structured report, build verification queries, and track remediation. Use when something broke in production, money was lost, users were affected, or a security issue was exploited. |
