...
<!-- auto-promoted from skills/engineering/dedalus-lerp by sync-dedalus on 2026-06-13; review & generalize any Dedalus-specific references. -->
...
| --- | --- | --- |
| `dedalus-lerp` | [`references/skills/dedalus-lerp/SKILL.md`](references/skills/dedalus-lerp/SKILL.md) | Audit prose (comments, docs, READMEs, commit messages, PR descriptions) for jargon, unexplained acronyms, and assumed context. Rewrites for the least experienced reader. Use after writing docs, READMEs, or any prose that will be read by someone who did not write the code. |
