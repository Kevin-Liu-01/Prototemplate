...
- If a different branch is active, stop and explain that Bugbot needs the target branch active. Offer a safe follow-up: the user can switch branches themselves, or the agent can create/use a separate worktree only after explicit approval.
