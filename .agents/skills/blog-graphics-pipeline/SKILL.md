---
name: blog-graphics-pipeline
description: Make the illustration set for a General Translation blog post with the graphics toolchain in this repository (graphics/): capture the real product at 3 to 5x, compose labelled crops over the glyphfield dither backgrounds, render at 7680 wide, review on contact sheets, export 3840-wide webp and GIF clips, and hand the set to the post as carousels. Use for any GT blog, docs or announcement graphic that must look like the product rather than generic AI art.
---
