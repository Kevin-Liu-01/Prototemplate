---
name: docs-source-capture
description: Capture pixel-faithful source screenshots of the General Translation docs (or any local Next.js page) for graphics: agent-browser at 3 to 5x device pixel ratio, both themes through the media emulation, the dev overlay hidden, and the trick for SSO-protected Vercel previews. Use before composing any product illustration.
---
